...
public class Contract {
	...
	private double discount; //ekptwsh
	private double finalCost; //kostos symbolaiou meta thn ekptwsh
	private String accountType; //typos logariasmou
	private String paymentMethod; //typos plhrwmhs
	private double cancellationCost; //kostos akyrwshs symbolaiou
	...
	public Contract(String code, long phoneNumber, long afm, String programType, long startDate, int contractDuration,
			double discount, double finalCost, String accountType, String paymentMethod, double cancellationCost,
