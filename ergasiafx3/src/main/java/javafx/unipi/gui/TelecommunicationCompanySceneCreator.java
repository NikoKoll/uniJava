...
public class TelecommunicationCompanySceneCreator extends SceneCreator implements EventHandler<MouseEvent> {
	...
	public void handle(MouseEvent event) {
		...
		if (event.getSource() == backBtn) {
            App.primaryStage.setTitle("ZooMainFX");
	   ...
	   if (event.getSource() == companyTableView) {
           ...
           if (selectedCompany != null) {
               ...
               phoneField.setText(Long.toString(selectedCompany.getPhone()));
	...
	//create Company
	public void createCompany(int companyCode , String companyName, long phone, String email) {
